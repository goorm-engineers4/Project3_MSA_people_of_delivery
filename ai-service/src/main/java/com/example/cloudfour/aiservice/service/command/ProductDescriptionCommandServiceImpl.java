...
import com.example.cloudfour.aiservice.builder.ProductPromptBuilder;
...
import com.example.cloudfour.aiservice.parser.ProductDescriptionResponseParser;
...
public class ProductDescriptionCommandServiceImpl {
    ...
    private final ProductDescriptionResponseParser responseParser;
    private final ProductPromptBuilder promptBuilder;
    public Mono<ProductDescriptionResponseDTO> generateProductDescription(ProductDescriptionRequestDTO request) {
        ...
        return geminiClient.generateContent(prompt)
                ...
                .onErrorResume(error -> {
                    ...
                    ProductDescriptionResponseDTO errorResponse = ProductDescriptionConverter.toErrorResponse(
                            "상품 설명 생성에 실패했습니다: " + error.getMessage());
                    String resultJson;
                    try {
                        com.fasterxml.jackson.databind.ObjectMapper objectMapper = new com.fasterxml.jackson.databind.ObjectMapper();
                        objectMapper.enable(com.fasterxml.jackson.databind.SerializationFeature.INDENT_OUTPUT);
